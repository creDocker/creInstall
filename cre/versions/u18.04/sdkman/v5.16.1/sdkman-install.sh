...
# install:- channel: stable; cliVersion: 5.16.1; cliNativeVersion: 0.1.0; api: https://api.sdkman.io/2
...
export SDKMAN_VERSION="5.16.1"
export SDKMAN_NATIVE_VERSION="0.0.20"
# infer platform
