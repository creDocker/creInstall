...
# install:- channel: stable; cliVersion: 5.22.3; cliNativeVersion: 0.7.24; api: https://api.sdkman.io/2
...
export SDKMAN_VERSION="5.22.3"
export SDKMAN_NATIVE_VERSION="0.7.24"
